...
export const updateAdminProfile = createAsyncThunk("admin/updateAdminProfile", async (pdata) => {
    try {
        const res = await axios.put("http://localhost:8080/admin/profile/update", pdata);
        return res.data;
    } catch (error) {
        console.log(error);
    }
