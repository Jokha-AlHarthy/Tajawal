...
export const getAllDestinations = createAsyncThunk("admin/getAllDestinations", async () => {
    try {
        const res = await axios.get("https://tajawalclient.onrender.com/admin/destinations");
        return res.data;
    } catch (error) {
        console.log(error);
    }
...
export const deleteDestination = createAsyncThunk("admin/deleteDestination", async (did) => {
    try {
        const res = await axios.delete(`https://tajawalclient.onrender.com/admin/destination/delete/${did}`);
        return res.data;
    } catch (error) {
        console.log(error);
    }
...
export const addDestination = createAsyncThunk("admin/addDestination", async (data) => {
    try {
        const res = await axios.post("https://tajawalclient.onrender.com/admin/destination/add", data);
        return res.data;
    } catch (error) {
        console.log(error);
    }
...
export const getAllUsers = createAsyncThunk("admin/getAllUsers", async () => {
    try {
        const res = await axios.get("https://tajawalclient.onrender.com/admin/users");
        return res.data;
    } catch (error) {
        console.log(error);
    }
...
export const deleteUser = createAsyncThunk("admin/deleteUser", async (email) => {
    try {
        const res = await axios.delete(`https://tajawalclient.onrender.com/admin/user/delete/${email}`);
        return res.data;
    } catch (error) {
        console.log(error);
    }
...
export const updateAdminProfile = createAsyncThunk("admin/updateAdminProfile",async (formData) => {
    const res = await axios.put(
      "https://tajawalclient.onrender.com/admin/profile/update",
      formData,
      {
...
export const updateUser = createAsyncThunk("admin/updateUser", async (data) => {
    try {
        const res = await axios.put("https://tajawalclient.onrender.com/admin/user/update", data);
        return res.data;
    } catch (error) {
        console.log(error);
    }
